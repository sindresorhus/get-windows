...
function windows() {
	...
	psapi.GetProcessMemoryInfo(processHandle, memoryCounters.ref(), ProcessMemoryCounters.size);
	...
	return {
		...
		memoryUsage: memoryCounters.WorkingSetSize === 0 ? undefined : memoryCounters.WorkingSetSize
	};
