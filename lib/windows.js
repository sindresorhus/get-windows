...
const kernel32 = new ffi.Library('kernel32', {
	...
	// TODO source
	GetProcessMemoryInfo: ['int', [ProcessMemoryCountersPointer]],
});
...
function windows() {
	...
	kernel32.GetProcessMemoryInfo(processHandle, memoryCounters.ref(), memoryCounters.size);
	console.log(memoryCounters);
	...
	user32.GetWindowRect(activeWindowHandle, bounds.ref(), bounds.size);
