...
// create the struct required to save the window Rect bounds
const Rect = Struct({
	left: 'long',
	top: 'long',
	right: 'long',
...
const RectPrt = ref.refType(Rect)
...
const user32 = new ffi.Library('User32.dll', {
	...
	GetWindowRect: ['bool', ['pointer', RectPrt]],
});
...
function windows() {
	...
	var bounds = new Rect();
	// get the window bounds and saves it into the 'bounds' var
